...
if [[ ${PV} == *9999 ]]; then
	...
	SRC_URI="
		https://github.com/qbittorrent/qBittorrent/releases/download/release-${PV}/${P}.tar.xz
		verify-sig? ( https://github.com/qbittorrent/qBittorrent/releases/download/release-${PV}/${P}.tar.xz.asc )
	"
	KEYWORDS="~amd64"
